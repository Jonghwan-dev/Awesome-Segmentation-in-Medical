...
from .other.kan import KANLinear, KAN
...
class UKAN(nn.Module):
    def __init__(self, out_channels, in_channels=3, deep_supervision=False, img_size=224, patch_size=16, in_chans=1, embed_dims=[256, 320, 512], no_kan=False,
    drop_rate=0., drop_path_rate=0., norm_layer=nn.LayerNorm, depths=[1, 1, 1], **kwargs):
        ...
        self.final = nn.Conv2d(embed_dims[0]//8, out_channels, kernel_size=1)
